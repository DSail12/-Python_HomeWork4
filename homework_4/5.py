...
k1 = int(input("Введите степень для первого многочлена k = "))   # создание двух файлов
k2 = int(input("Введите степень для второго многочлена k = "))
koef1 = create_mn(k1)
koef2 = create_mn(k2)
write_file("file_1 for exercie_5.txt", create_str(koef1))
write_file("file_2 for exercie_5.txt", create_str(koef2))
with open('file_1 for exercie_5.txt', 'r') as data:         # нахождение суммы многочлена
    st1 = data.readlines()
with open('file_2 for exercie_5.txt', 'r') as data:
    st2 = data.readlines()
